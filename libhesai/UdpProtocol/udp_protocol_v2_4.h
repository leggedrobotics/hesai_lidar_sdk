...
struct HS_LIDAR_BODY_LASTER_UNIT_ET_V4
{
  ...
  {
    return little_to_native(distance);
  }
...
struct HS_LIDAR_BODY_SEQ2_ET_V4
{
  ...
  int16_t GetHorizontalAngle() const
  {
    return little_to_native(horizontalAngle);
  }
  int16_t GetVerticalAngle() const
  {
    return little_to_native(verticalAngle);
  }
} PACKED;
...
struct HS_LIDAR_TAIL_ET_V4
{
  ...
  {
    return m_u8EchoMode == kLastReturn;
  }
  bool IsStrongestReturn() const
  {
    return m_u8EchoMode == kStrongestReturn;
  }
  bool IsDualReturn() const
  {
    return m_u8EchoMode == kDualReturn;
  }
  bool IsFirstReturn() const
  {
    return m_u8EchoMode == kFirstReturn;
  }
  ...
  void Print() const
  {
    ...
    printf(
        ...
        "%u %u %u %u\n",
        GetStsID0(), GetData0(), GetStsID1(), GetData1(), HasShutdown(), GetTimestamp(), GetReturnMode(),
        GetFactoryInfo(), GetUTCData(0), GetUTCData(1), GetUTCData(2), GetUTCData(3), GetUTCData(4), GetUTCData(5));
  }
} PACKED;
...
struct HS_LIDAR_HEADER_ET_V4
{
  ...
  {
    return m_u8Reserved2 & kSequenceNum;
  }
  bool HasIMU() const
  {
    return m_u8Reserved2 & kIMU;
  }
  bool HasFuncSafety() const
  {
    return m_u8Reserved2 & kFunctionSafety;
  }
  bool HasCyberSecurity() const
  {
    return m_u8Reserved2 & kCyberSecurity;
  }
  bool HasConfidenceLevel() const
  {
    return m_u8Reserved2 & kConfidenceLevel;
  }
  bool HasWeightFactor() const
  {
    return m_u8Reserved2 & kWeightFactor;
  }
  ...
  uint16_t GetPacketSize() const
  {
    return (sizeof(struct HS_LIDAR_PRE_HEADER) + sizeof(struct HS_LIDAR_HEADER_ET_V4) +
            (sizeof(uint16_t) +
             (sizeof(struct HS_LIDAR_BODY_LASTER_UNIT_ET_V4) * (m_u8LaserNum / m_u8SeqNum) + 4) * m_u8SeqNum) *
                m_u8BlockNum +
            sizeof(struct HS_LIDAR_BODY_CRC_ET_V4) + sizeof(struct HS_LIDAR_TAIL_ET_V4) +
            sizeof(struct HS_LIDAR_TAIL_SEQ_NUM_ET_V4) + sizeof(struct HS_LIDAR_TAIL_CRC_ET_V4));
  }
  void Print() const
  {
