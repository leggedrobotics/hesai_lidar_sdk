...
//**********************************Start the configuration.**********************************//
  ...
  // set param
  // Some lidar sets IP and then restarts. If you have a register setting requirement, it will invalidate your register
  // setting. If you don't have the need to set the register to lose the set value when the power goes down, just put
  // the lidar network setting after all the settings.
  int is_set_net = 0;
  if (is_set_net)
  {
